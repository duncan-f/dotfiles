...
## Type: Font
c.fonts.monospace = 'Tamzen, "Ubuntu Mono", "xos4 Terminus", Terminus, Monospace, "DejaVu Sans Mono", Monaco, "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Consolas, Terminal'
...
c.url.searchengines = {
        ...
        'deb': 'https://search.debian.org/cgi-bin/omega?P={}',
...
config.bind('yy', 'yank')
config.bind('zg', 'quickmark-load gitme')
config.bind('zy', 'quickmark-load tube')
config.bind('zz', 'set-cmd-text -s :quickmark-load')
